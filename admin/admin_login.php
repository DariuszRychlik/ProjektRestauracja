...
<p style="font-size: 2rem;"> login = admin ; hasło = 111</p>
...
<section class="form-container">
   ...
   <form action="" method="POST">
      <h3>zaloguj się</h3>
      <input type="text" name="name" maxlength="20" required placeholder="podaj login" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
